...
export function PhysicalCodingLab(){
 ...
 {issue&&<div role="alert" className="coding-error">{issue}{staticDeployment&&<> <a href="https://github.com/Sudharsanselvaraj/Flylab#quick-start">Open Quick Start ↗</a></>}</div>}
